...
Given("the teacher has a class with {int} students", function (students) {
...
When('the teacher views the attendance summary', function () {
  this.summary = this.teacher.studentAttendanceSummary(1);
});

Then('the summary should show the attendance of each student', function () {
